...
class QuestionBank {
// creating a property for this QuestionBank class
    var list = [Question]()
    
    // there aren't any parameters in this init() so when you access it, you will not need arguments, you will access it as "QuestionBank() " 
    init(){
        ...
        // skipping one step, not creating a new variable (item) and just creating the quiz item inside the append function
